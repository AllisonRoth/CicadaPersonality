...
ggplot() +
  ...
  labs(y = "Successful Copulation (Yes = 1 & No = 0)", x = "Exploratory Behavior Score (z transformed)")
...
ggplot() +
  ...
  theme(legend.position = "none")  +
  labs(y = "Number of Male-Male Copulation Attempts", x = "Exploratory Behavior Score (z transformed)")
